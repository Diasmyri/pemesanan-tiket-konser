...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* ================= CARD ================= */
        .card-box {
            background: linear-gradient(160deg, rgba(30, 37, 58, 0.80), rgba(16, 19, 33, 0.80));
...
<div class="sidebar">
    ...
    <ul class="submenu">
        <li><a href="/admin/masters/artists" class="active"><i class="fas fa-microphone"></i> Artists</a></li>
    ...
    <ul class="submenu">
        ...
        <li><a href="/admin/transactions/refund/create"><i class="fas fa-plus"></i> Ajukan Refund</a></li>
    </ul>
...
<div class="content">
    ...
    <p class="small-muted">Isi data artist dengan lengkap.</p>
        ...
        <form action="<?= $formAction ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group mb-4">
                <label for="name" class="form-label">
                    <i class="fas fa-user"></i> Nama Artist
                </label>
            ...
            <div class="form-group mb-4">
                <label for="photo" class="form-label">
                    <i class="fas fa-camera"></i> Foto Artist
                </label>
                <input type="file" name="photo" id="photo" class="form-control file-input"
                       accept="image/*" onchange="previewImage(event)">
                <div class="preview-container">
                    <?php if (!empty($artist['photo'])): ?>
                        <img id="preview" src="/uploads/artists/<?= $artist['photo'] ?>" class="preview-img" alt="Preview">
                    <?php else: ?>
                        <img id="preview" src="#" class="preview-img" style="display:none;" alt="Preview">
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="form-actions">
                <button type="submit" class="btn-save">
                    <i class="fas fa-save"></i> Simpan Artist
                </button>
            </div>
