...
<div class="content">
    ...
    <p style="color:#9aa4c7;">Daftar proses check-in tiket.</p>
    ...
    <div class="card-box">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <a href="/admin/transactions/checkin/create" class="action-btn">
        ...
        <table class="table table-bordered table-dark table-hover mt-3">
            ...
            <?php if(empty($checkins)): ?>
                <tr>
                    <td colspan="5" class="text-center text-secondary py-3">Belum ada data check-in.</td>
                </tr>
            <?php else: ?>
